<?php
    ...
    $sql = "SELECT * FROM dht22_log.log ORDER BY \"time\" DESC;";
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <!-- Brand -->
            <a class="navbar-brand" href="/index.php">溫溼度紀錄系統</a>
        ...
        <!-- 網頁本體 -->
        <div class="container">
            <h1 style="text-align: center; margin-top: 1rem;">溫溼度紀錄(DHT22)</h1>
            <div class="row">
                <div class="col">
